data "coder_parameter" "baseline_image" {
  ...
  option {
    ...
    value = "ubuntu-desktop-2204"
  }

  option {
    name  = "Ubuntu 22.04 LTS (Server)"
    value = "ubuntu-server-2204"
  }

  option {
    name  = "Ubuntu 20.04 LTS (Desktop)"
    value = "ubuntu-desktop-2004"
  }

  option {
    name  = "Ubuntu 20.04 LTS (Server)"
    value = "ubuntu-server-2004"
  }

  option {
    name  = "Ubuntu 18.04 LTS (Desktop)"
    value = "ubuntu-desktop-1804"
  }

  option {
    name  = "Ubuntu 18.04 LTS (Server)"
    value = "ubuntu-server-1804"
  }
}
